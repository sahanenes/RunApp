...
namespace RunApp.Migrations
{
    ...
    [Migration("20240108044759_AddCityStateProfileImage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RunApp.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RunApp.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RunApp.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RunApp.Models.Club", b =>
                {
                    ...
                    b.HasOne("RunApp.Models.AppUser", "AppUser")
                        .WithMany("Clubs")
